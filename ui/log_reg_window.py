# Form implementation generated from reading ui file 'log_reg.ui'
#
...
class Ui_LogRegWindow(object):
    def setupUi(self, LogRegWindow):
        ...
        self.sign_up_password_visibile.setObjectName(
            "sign_up_password_visibile")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/eye.svg"),
                        QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.sign_up_show_password.setIcon(icon1)
        ...
        self.forgot_password_label.setStyleSheet("color: rgb(255, 255, 255);\n"
                                                 "font: 300 8pt \"Poppins\";")
