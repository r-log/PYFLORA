# Form implementation generated from reading ui file 'main_window_novi_ui.ui'
#
...
"}")
        ...
        self.logo_widget_mainwindow = QtWidgets.QWidget(parent=self.header_widget)
        ...
        self.logo_widget_mainwindow.setStyleSheet("background-color:transparent;")
        self.logo_widget_mainwindow.setObjectName("logo_widget_mainwindow")
        self.log_reg_py_text_label = QtWidgets.QLabel(parent=self.logo_widget_mainwindow)
...
"")
        self.log_reg_py_text_label.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.log_reg_py_text_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.log_reg_py_text_label.setObjectName("log_reg_py_text_label")
        self.logo_line_label = QtWidgets.QFrame(parent=self.logo_widget_mainwindow)
...
"border-style: inset;")
        ...
        self.log_reg_flora_text_label = QtWidgets.QLabel(parent=self.logo_widget_mainwindow)
        self.log_reg_flora_text_label.setGeometry(QtCore.QRect(34, 19, 151, 41))
        font = QtGui.QFont()
        font.setFamily("Poppins")
        font.setPointSize(30)
        font.setBold(False)
...
"color: rgb(255, 255, 255);")
        self.log_reg_flora_text_label.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.log_reg_flora_text_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/Icons/Icons/magnifying-glass-thin.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.search_button.setIcon(icon)
        self.search_button.setCheckable(True)
        self.search_button.setObjectName("search_button")
        self.horizontalLayout_4.addWidget(self.search_button)
        spacerItem1 = QtWidgets.QSpacerItem(107, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
...
"border-radius:15px;")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/Icons/Icons/bell-thin.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon1.addPixmap(QtGui.QPixmap(":/Icons/Icons/bell-slash-thin.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        ...
        self.dropdown_notification_button = QtWidgets.QPushButton(parent=self.widget_5)
...
"border-radius:15px;")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/Icons/Icons/angle-down-thin.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.dropdown_notification_button.setIcon(icon2)
        self.dropdown_notification_button.setCheckable(True)
        self.dropdown_notification_button.setObjectName("dropdown_notification_button")
        ...
        self.notifications_info_label.setMaximumSize(QtCore.QSize(16777215, 31))
        self.notifications_info_label.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.notifications_info_label.setStyleSheet("background-color: rgb(18, 88, 83);")
        self.notifications_info_label.setTextFormat(QtCore.Qt.TextFormat.RichText)
        self.notifications_info_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
...
"border-radius:15px;")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/Icons/Icons/Minus.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"border-radius:15px;")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/Icons/Icons/maximize-2.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon4.addPixmap(QtGui.QPixmap(":/Icons/Icons/minimize-2.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        ...
        self.exit_button.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.exit_button.setStyleSheet("background-color: rgb(18, 88, 83);\n"
"border-radius:15px;")
        self.exit_button.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/Icons/Icons/x.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.sidemenu_closed_widget = QtWidgets.QWidget(parent=self.main_widget)
        self.sidemenu_closed_widget.setMaximumSize(QtCore.QSize(81, 16777215))
        self.sidemenu_closed_widget.setStyleSheet("background-color: transparent;")
        ...
        self.account_button_closed_menu = QtWidgets.QPushButton(parent=self.sidemenu_closed_widget)
...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/Icons/Icons/circle-info-thin.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.account_button_closed_menu.setObjectName("account_button_closed_menu")
        ...
        self.home_button_closed_menu = QtWidgets.QPushButton(parent=self.sidemenu_closed_widget)
...
"}")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/Icons/Icons/house-thin.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.plants_button_closed_menu = QtWidgets.QPushButton(parent=self.sidemenu_closed_widget)
...
"}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/Icons/Icons/seedling-thin.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.plants_button_closed_menu.setObjectName("plants_button_closed_menu")
        self.verticalLayout.addWidget(self.plants_button_closed_menu)
        self.livefeed_button_closed_menu = QtWidgets.QPushButton(parent=self.sidemenu_closed_widget)
...
"}")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/Icons/Icons/video-thin.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.livefeed_button_closed_menu.setObjectName("livefeed_button_closed_menu")
        self.verticalLayout.addWidget(self.livefeed_button_closed_menu)
        self.analytics_button_closed_menu = QtWidgets.QPushButton(parent=self.sidemenu_closed_widget)
...
"}")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/Icons/Icons/chart-simple-thin.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.analytics_button_closed_menu.setObjectName("analytics_button_closed_menu")
        self.verticalLayout.addWidget(self.analytics_button_closed_menu)
        spacerItem4 = QtWidgets.QSpacerItem(20, 120, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        self.verticalLayout.addItem(spacerItem4)
        self.logout_button_closed_menu = QtWidgets.QPushButton(parent=self.sidemenu_closed_widget)
...
"}")
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/Icons/Icons/arrow-right-from-bracket-thin.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.logout_button_closed_menu.setObjectName("logout_button_closed_menu")
        ...
        self.sidemenu_opened_widget = QtWidgets.QWidget(parent=self.main_widget)
        ...
        self.sidemenu_opened_widget.setStyleSheet("background-color: transparent;")
        ...
        self.account_button_opened_menu = QtWidgets.QPushButton(parent=self.sidemenu_opened_widget)
        ...
        self.account_button_opened_menu.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.DefaultContextMenu)
...
"}")
        ...
        self.account_button_opened_menu.setObjectName("account_button_opened_menu")
        self.gridLayout_3.addWidget(self.account_button_opened_menu, 0, 0, 1, 1)
        ...
        self.plants_button_opened_menu = QtWidgets.QPushButton(parent=self.sidemenu_opened_widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.plants_button_opened_menu.sizePolicy().hasHeightForWidth())
        ...
        self.plants_button_opened_menu.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
...
"}")
        ...
        self.plants_button_opened_menu.setObjectName("plants_button_opened_menu")
        self.gridLayout_4.addWidget(self.plants_button_opened_menu, 1, 0, 1, 1)
        self.home_button_opened_menu = QtWidgets.QPushButton(parent=self.sidemenu_opened_widget)
...
"}")
        ...
        self.analytics_button_opened_menu = QtWidgets.QPushButton(parent=self.sidemenu_opened_widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.analytics_button_opened_menu.sizePolicy().hasHeightForWidth())
        ...
        self.analytics_button_opened_menu.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
...
"}")
        ...
        self.analytics_button_opened_menu.setObjectName("analytics_button_opened_menu")
        self.gridLayout_4.addWidget(self.analytics_button_opened_menu, 3, 0, 1, 1)
        self.livefeed_button_opened_menu = QtWidgets.QPushButton(parent=self.sidemenu_opened_widget)
...
"}")
        ...
        self.livefeed_button_opened_menu.setObjectName("livefeed_button_opened_menu")
        self.gridLayout_4.addWidget(self.livefeed_button_opened_menu, 2, 0, 1, 1)
        self.verticalLayout_2.addLayout(self.gridLayout_4)
        spacerItem6 = QtWidgets.QSpacerItem(20, 120, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        self.verticalLayout_2.addItem(spacerItem6)
        self.gridLayout_5 = QtWidgets.QGridLayout()
        self.gridLayout_5.setSpacing(0)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.logout_button_opened_menu = QtWidgets.QPushButton(parent=self.sidemenu_opened_widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.logout_button_opened_menu.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        self.logout_button_opened_menu.setObjectName("logout_button_opened_menu")
...
"")
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/Icons/Icons/chevron-left.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon12.addPixmap(QtGui.QPixmap(":/Icons/Icons/chevron-right.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        ...
        self.content_stacked_widget = QtWidgets.QStackedWidget(parent=self.main_widget)
...
"border-bottom-left-radius:50px;")
        ...
        self.account_page_label = QtWidgets.QLabel(parent=self.Account)
        self.account_page_label.setGeometry(QtCore.QRect(370, 210, 101, 16))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        font.setBold(True)
        self.account_page_label.setFont(font)
        self.account_page_label.setStyleSheet("color: rgb(255, 255, 255);")
        self.account_page_label.setObjectName("account_page_label")
        ...
        self.open_menu_button.toggled['bool'].connect(self.sidemenu_closed_widget.setVisible) # type: ignore
        self.open_menu_button.toggled['bool'].connect(self.sidemenu_opened_widget.setHidden) # type: ignore
        self.account_button_closed_menu.toggled['bool'].connect(self.account_button_opened_menu.setChecked) # type: ignore
        self.account_button_opened_menu.toggled['bool'].connect(self.account_button_closed_menu.setChecked) # type: ignore
        self.home_button_closed_menu.toggled['bool'].connect(self.home_button_opened_menu.setChecked) # type: ignore
        self.home_button_opened_menu.toggled['bool'].connect(self.home_button_closed_menu.setChecked) # type: ignore
        self.plants_button_closed_menu.toggled['bool'].connect(self.plants_button_opened_menu.setChecked) # type: ignore
        self.plants_button_opened_menu.toggled['bool'].connect(self.plants_button_closed_menu.setChecked) # type: ignore
        self.livefeed_button_closed_menu.toggled['bool'].connect(self.livefeed_button_opened_menu.setChecked) # type: ignore
        self.livefeed_button_opened_menu.toggled['bool'].connect(self.livefeed_button_closed_menu.setChecked) # type: ignore
        self.analytics_button_closed_menu.toggled['bool'].connect(self.analytics_button_opened_menu.setChecked) # type: ignore
        self.analytics_button_opened_menu.toggled['bool'].connect(self.analytics_button_closed_menu.setChecked) # type: ignore
        self.logout_button_closed_menu.toggled['bool'].connect(self.logout_button_opened_menu.setChecked) # type: ignore
        self.logout_button_opened_menu.toggled['bool'].connect(self.logout_button_closed_menu.setChecked) # type: ignore
        self.exit_button.clicked.connect(MainWindow.close) # type: ignore
        self.maximize_button.clicked['bool'].connect(MainWindow.showMaximized) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.log_reg_flora_text_label.setText(_translate("MainWindow", "FLORA"))
        self.notifications_info_label.setText(_translate("MainWindow", "New notfications!"))
        self.account_button_opened_menu.setText(_translate("MainWindow", "Account"))
        self.plants_button_opened_menu.setText(_translate("MainWindow", "Plants"))
        self.home_button_opened_menu.setText(_translate("MainWindow", "Home"))
        self.analytics_button_opened_menu.setText(_translate("MainWindow", "Analytics"))
        self.livefeed_button_opened_menu.setText(_translate("MainWindow", "Livefeed"))
        self.logout_button_opened_menu.setText(_translate("MainWindow", "Log-out"))
        self.home_page_label.setText(_translate("MainWindow", "HOME"))
        self.livefeed_page_label.setText(_translate("MainWindow", "LIVEFEED"))
        self.analytics_page_label.setText(_translate("MainWindow", "ANALYTICS"))
        self.account_page_label.setText(_translate("MainWindow", "ACCOUNT"))
